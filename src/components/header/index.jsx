        ...
        <nav className="bg-white border-gray-200 h-20 px-4 lg:px-6 py-2.5 backdrop-blur-sm bg-white/5">
          <div className="flex flex-wrap justify-between mt-2 items-center mx-auto max-w-screen-xl">
            ...
            <div className="flex items-center lg:order-2">
              ...
              <a
                href="#"
                className="text-white bg-cyan-600 bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800"
              >
                Get started
              </a>
              <button
